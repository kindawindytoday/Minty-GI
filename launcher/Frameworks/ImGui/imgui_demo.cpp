...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Password Input"))
        {
            ...
            ImGui::InputTextWithHint("password (w/ hint)", "<password>", password, IM_ARRAYSIZE(password), { 0,0 }, ImGuiInputTextFlags_Password);
...
struct ExampleAppPropertyEditor
{
    ...
    void Draw(ExampleTreeNode* root_node)
    {
        ...
        if (ImGui::BeginChild("##tree", ImVec2(300, 0), ImGuiChildFlags_ResizeX | ImGuiChildFlags_Borders | ImGuiChildFlags_NavFlattened))
        {
            ...
            if (ImGui::InputTextWithHint("##Filter", "incl,-excl", Filter.InputBuf, IM_ARRAYSIZE(Filter.InputBuf), { 0,0 }, ImGuiInputTextFlags_EscapeClearsAll))
                Filter.Build();
            ImGui::PopItemFlag();
