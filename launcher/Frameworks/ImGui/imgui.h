...
namespace ImGui
{
    ...
    IMGUI_API bool          ArrowButton(const char* str_id, ImGuiDir dir, float sz);                  // square button with an arrow shape
    ...
    IMGUI_API bool          InputTextWithHint(const char* label, const char* hint, char* buf, size_t buf_size, ImVec2 size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
